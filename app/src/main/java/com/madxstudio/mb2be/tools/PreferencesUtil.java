...
import com.madxstudio.mb2be.App;
...
public class PreferencesUtil {
    ...
    private PreferencesUtil(Context context) {
        this.sharedPreferences = context.getSharedPreferences(Constant.PREFERENCE_NAME, Context
                .MODE_PRIVATE);
    ...
    private static void init() {
        if (preferencesUtil == null) {
            preferencesUtil = new PreferencesUtil(App.getInstance());
        }
    }
